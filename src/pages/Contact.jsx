        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-section">
                    <ContactItem icon={phone} text1={"+880 1949219218"} text2={'+880 1571237056'} title={"Phone"} />
                    <ContactItem icon={email} text1={"+880 1949219218"} text2={'+880 1571237056'} title={"Phone"} />
                    <ContactItem icon={location} text1={"+880 1949219218"} text2={'+880 1571237056'} title={"Phone"} />
                </div>
            </div>
        </div>
    );
